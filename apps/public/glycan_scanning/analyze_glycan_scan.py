...
import jade2.rosetta_jade.ScoreFiles as score_utils
import pandas as pd
...
if __name__ == "__main__":
    ...
    if options.get_top:
        ...
        score_paths_top = list(zip(scores_top, paths_top, names_top))
        ...
        score_paths = list(zip(scores, paths, names))

        organized_names = defaultdict()
        for score_path in score_paths:
            name = score_path[2]
            if name not in organized_names:
