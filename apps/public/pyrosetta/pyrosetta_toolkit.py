...
#Toolkit Imports
from jade2.pyrosetta_toolkit.modules import tools
from jade2.pyrosetta_toolkit.window_main.menu import *
from jade2.pyrosetta_toolkit.window_main import global_variables
from jade2.pyrosetta_toolkit.window_main.frames.InputFrame import InputFrame
from jade2.pyrosetta_toolkit.window_main.frames.OutputFrame import OutputFrame
from jade2.pyrosetta_toolkit.window_main.frames.QuickProtocolsFrame import QuickProtocolsFrame
from jade2.pyrosetta_toolkit.window_main.frames.SimpleAnalysisFrame import SimpleAnalysisFrame
from jade2.pyrosetta_toolkit.window_main.IO.GUIInput import GUIInput
from jade2.pyrosetta_toolkit.window_main.IO.GUIOutput import GUIOutput

from jade2.pyrosetta_toolkit.window_modules.pymol_integration.PyMOL import AdvancedPyMOL
...
class main_window:
   ...
   ### TextBox ###
      ...
      outfont = tkinter.font.Font(family="Helvetica", size=11)
