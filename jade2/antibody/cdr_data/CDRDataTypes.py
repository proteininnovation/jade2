...
#PyIgClassify
from jade2.antibody.CDRClusterer import *
from jade2.basic import fasta

#Modules
from jade2.antibody.cdr_data.CDRData import *
from jade2.basic.sequence.ClustalRunner import *
from jade2.basic.structure.BioPose import *
...
class CDRAlignedSequenceData(CDRSequenceData):
    ...
    def get_concatonated_map(self, only_cdr = None, decoy_list = None, use_saved_data = True):
        ...
        for cdr in self.cdrs:
            ...
            for decoy in new_data:
                ...
                if cdr_decoy not in final_result_data:
    ...
    def _make_fasta_for_concatonated(self, concatonated_data, cdr, name):
        ...
        for decoy in list(concatonated_data.keys()):
    ...
    def _parse_clustal_for_concatonated(self, concatonated_data, cdr, clustal_path):
        ...
        for line in INFILE:
            ...
            if decoy not in concatonated_data:
                continue
