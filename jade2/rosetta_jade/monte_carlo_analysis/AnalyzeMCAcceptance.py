...
from jade2.basic import path as path_tools
import numpy
from jade2.basic.figure.creation import MakeFigure
...
### I think I'll be deprecating this old baby in favor of ipython notebooks and dataframe.
    ...
    def plot_cycle_by_e(self):
        def add_data(maker, all_models, include_native, final_e, range_only = None):
                ...
                for cy_data in all_models:
                    ...
                    if range_only:
                        r = list(range(range_only[0], range_only[1]))
                        #print repr(r)
                    else:
                        r = list(cy_data.values.keys())
        ...
        for exp in self.all_data:
            ...
            for pdb_id in list(mc_data.data.keys()):
    ...
    def plot_cum_acceptance(self):
        def add_data(maker, all_models):
                ...
                for cy_data in all_models:
                    ...
                    x = [z for z in range(1, len(list(cy_data.values.keys())) +1)]
                    #print repr(x)
                    r = list(cy_data.values.keys())
