...
from jade2.rosetta_jade.SetupRosettaOptionsBenchmark import SetupRosettaOptionsBenchmark
from jade2.rosetta_jade.RunRosetta import RunRosetta
...
class RunRosettaBenchmarks(RunRosetta):
    ...
    def _get_make_out_path(self):
        ...
        for key in self._current_settings_ordered_keys:
            ...
            if key in self._current_settings and self._current_settings[key] != None:
