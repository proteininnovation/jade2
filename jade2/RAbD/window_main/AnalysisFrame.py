...
class AnalysisFrame(Frame):
    ...
    def copy_to_dir(self):
        ...
        dir_out = tkinter.filedialog.askdirectory(initialdir=self.main_gui.current_dir, title = "Copy to DIR")
    ...
    def copy_to_dir_and_rename(self):
        ...
        for decoy in self.get_decoys():
            if not os.path.exists(decoy):
                ...
                new_name = tkinter.simpledialog.askstring(title="Decoy Name", prompt="Enter a new decoy name")
    ...
    def check_set_pyigclassify(self):
        if not os.path.exists(self.compare_designs.pyigclassify_dir.get()):
            ...
            pyigclassify_dir = tkinter.filedialog.askdirectory(initialdir=self.main_gui.current_dir, title="PyIgClassify DIR")
