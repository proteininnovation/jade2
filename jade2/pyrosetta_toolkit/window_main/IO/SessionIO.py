...
class SessionIO:
    ...
    def save_session(self):
        ...
        name = tkinter.simpledialog.askstring(title="Session Name", prompt="Please enter a name for this session.")
        if not name:return
        outdir = outdir+"/"+name
        if not os.path.exists(outdir):
            os.mkdir(outdir)
    ...
    def load_session(self):
        ...
        self.indir = tkinter.filedialog.askdirectory(title="Open session directory", initialdir=self.toolkit.toolkit_home+"/SESSIONS")
