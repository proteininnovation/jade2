...
#Module Imports
from jade2.pyrosetta_toolkit.modules.tools import output as output_tools
from jade2.pyrosetta_toolkit.modules.tools import analysis as analysis_tools
from jade2.pyrosetta_toolkit.modules.tools import general_tools
from jade2.pyrosetta_toolkit.modules.tools import sequence

from jade2.pyrosetta_toolkit.modules import help as help_tools
from jade2.pyrosetta_toolkit.modules.tools import input as input_tools
from jade2.pyrosetta_toolkit.modules import calibur
from jade2.pyrosetta_toolkit.modules.ScoreAnalysis import ScoreAnalysis
from jade2.pyrosetta_toolkit.modules.DesignBreakdown import DesignBreakdown
from jade2.pyrosetta_toolkit.modules.protocols.DockingProtocols import DockingProtocols
from jade2.pyrosetta_toolkit.modules.protocols.DesignProtocols import DesignProtocols
from jade2.pyrosetta_toolkit.modules.protocols.LowResLoopModelingProtocols import LowResLoopModelingProtocols
from jade2.pyrosetta_toolkit.modules.protocols.HighResLoopModelingProtocols import HighResLoopModelingProtocols
from jade2.pyrosetta_toolkit.modules.protocols.GraftingProtocols import GraftMoverWindow
from jade2.pyrosetta_toolkit.modules.protocols.AnalysisProtocols import AnalysisProtocols
from jade2.pyrosetta_toolkit.modules.protocols.FloppyTailProtocol import FloppyTailProtocol
from jade2.pyrosetta_toolkit.modules.protocols.MinimizationProtocols import MinimizationProtocols

from jade2.pyrosetta_toolkit.window_modules.clean_pdb.FixPDBWindow import FixPDBWindow


from jade2.pyrosetta_toolkit.window_modules.design.ResfileDesignWindow import ResfileDesignWindow
from jade2.pyrosetta_toolkit.window_modules.ligand_ncaa_ptm_manager.ligand_ncaa_ptm_manager import ligand_ncaa_ptm_manager
from jade2.pyrosetta_toolkit.window_modules.full_control.FullControlWindow import FullControlWindow
from jade2.pyrosetta_toolkit.window_modules.insert_bfactor.InsertBFactor import InsertBFactor

from . import global_variables
from jade2.pyrosetta_toolkit.window_main.IO import SessionIO
...
class Menus():
    ...
    def _set_options_menu(self):
        ...
        self.rounds_options_menu.add_command(label = "Set processors to use", command = lambda: self.toolkit.output_class.processors.set(tkinter.simpledialog.askinteger(title="Processesors", prompt= "Please set the number of processess you wish to create for protocol runs.", initialvalue=self.toolkit.output_class.processors.get())))
...
##### MENU FUNCTIONS #######
    ...
    def load_scores_for_score_analysis(self):
        filename = tkinter.filedialog.askopenfilename(title="Open ScoredPDBList, .fasc, or .sc file", initialdir=global_variables.current_directory)
    ...
    def get_path(self, string):
        path = tkinter.filedialog.askopenfilename(title=string,initialdir = global_variables.current_directory)
        return path
