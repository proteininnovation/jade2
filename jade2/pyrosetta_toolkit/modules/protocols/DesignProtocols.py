...
class DesignProtocols(ProtocolBaseClass):
    ...
    def setupPackDesign(self, main):
        ...
        def packDesign():
            resfile = tkinter.filedialog.askopenfilename(initialdir = global_variables.current_directory, title="Open Resfile..")
    ...
    def remodel(self, blueprint=False):
        ...
        if not blueprint:
            blueprint = tkinter.filedialog.askopenfilename(initialdir = global_variables.current_directory, title="Open Blueprint..")
    ...
    def pack_residue(self, res, chain):
        ...
        pack_radius = tkinter.simpledialog.askfloat(title="Pack radius", prompt = "Please enter the desired neighbor packing radius (A)", initialvalue=5.0)
    ...
    def _get_set_pack_neighbors(self, res, task):
        ...
        """
        radius = tkinter.simpledialog.askfloat(title="Pack radius", prompt = "Please enter the desired neighbor packing radius (A)", initialvalue=0.0)
