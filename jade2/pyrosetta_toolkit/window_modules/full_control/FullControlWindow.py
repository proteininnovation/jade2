...
#Toolkit Imports
import jade2.pyrosetta_toolkit.modules.tools.analysis as analysis_tools
from jade2.pyrosetta_toolkit.modules.definitions.restype_definitions import *
from jade2.pyrosetta_toolkit.modules.tools import general_tools
from jade2.pyrosetta_toolkit.modules.tools import protocols as protocol_tools
...
from jade2.pyrosetta_toolkit.modules.RegionalScoring import *
...
class FullControlWindow():
    ...
    def show_window(self, master, r=0, c=0):
        ...
        try :
            ...
            tkinter.messagebox.showwarning(message = 'Please Load a Pose...')
            return
