...
from jade2.pyrosetta_toolkit.modules.PythonPDB import PythonPDB
...
class FixPDBWindow:
     ...
     def load_cleaned_pdb(self, pdbpath=False):
          ...
          if not self.ignore_unrecognized_option_set:
               ...
               if unique:
                    ...
                    keep_going =  tkinter.messagebox.askyesno(title="Continue?", message = "Rosetta may be unable to read these residues: "+aa_string+". Continue?")
     ...
     def getfile(self):
          ...
          """
          filepath = tkinter.filedialog.askopenfilename(initialdir = global_variables.current_directory)
