...
### Functions ###
    ...
    def insert(self):
        filename = tkinter.filedialog.askopenfilename(title="Data file", initialdir=global_variables.current_directory)
        ...
        outname = tkinter.filedialog.asksaveasfilename(title="Output PDB Name", initialdir=global_variables.current_directory)
