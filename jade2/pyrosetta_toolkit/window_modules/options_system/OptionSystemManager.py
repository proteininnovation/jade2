...
class OptionSystemManager:
    ...
    def load_settings(self, path):
        if path != self.pwd+"/settings.txt":
            path = tkinter.filedialog.askopenfilename(initialdir=self.current_directory, title='Option Settings')
            if not path:return
    ...
    def save_settings(self, path):
        ...
        if path != self.pwd+"/settings.txt":
            path = tkinter.filedialog.asksaveasfilename(initialdir=self.current_directory, title='Option Settings')
