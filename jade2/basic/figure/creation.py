...
from jade2.basic.figure.util import *
...
def plot_general_pandas(df, title, outpath, plot_type, x, y = None, z = None, top_p = .95, reverse = True):
    """
    Plot anything in dataframe.  Make it look descent.  Save the figure.
    ...
    if y:
        ...
        #Y=X is not an error.  For KDE plots, dataframe uses y instead of X.  Super stupid.
...
class MakeFigure:
    ...
    My take on a figure interface.  Because I think matplotlib's interface sucks.

    I wrote this before I knew of dataframe.
