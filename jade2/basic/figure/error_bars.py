...
from jade2.basic.stats import calculate_stddev_binomial_distribution
from jade2.basic.stats import calculate_stddev
...
def calculate_set_errorbars_hist(ax, data, x, y,
    ...
    Note:
     If Hue is enabled, this base is divided by the number of hue_names for the final width used for figure.
